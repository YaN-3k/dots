...
loadxrdb()
{
	...
	if (display != NULL) {
		...
		if (resm != NULL) {
			...
			if (xrdb != NULL) {
				XRDB_LOAD_COLOR("tabbed.normbgcolor", normbgcolor);
				XRDB_LOAD_COLOR("tabbed.normfgcolor", normfgcolor);
				XRDB_LOAD_COLOR("tabbed.selbgcolor", selbgcolor);
				XRDB_LOAD_COLOR("tabbed.selfgcolor", selfgcolor);
			}
		}
	}
